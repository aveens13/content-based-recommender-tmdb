...
dataset = pd.read_sql_query("SELECT * FROM movies", conn)
...
# dataset = pd.read_sql_query("SELECT * FROM tmdb_movies", conn)
# credits = pd.read_sql_query("SELECT * FROM tmdb_credits", conn)
# conn.close()
